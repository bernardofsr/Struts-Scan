...
class struts_baseverify:
    ...
    def check(self, pocname, vulnstr):
         if vulnstr.find("Active Internet connections") != -1:
             cprint("Target exists" + pocname + "vulnerabilities..[Linux]", "red")
             filecontent.writelines(pocname+" success!!!"+"\n")
         elif vulnstr.find("Active Connections") != -1:
             cprint("Target exists" + pocname + "vulnerabilities..[Windows]", "red")
             filecontent.writelines(pocname+" success!!!"+"\n")
         elif vulnstr.find("active connection") != -1:
             cprint("Target exists" + pocname + "vulnerabilities..[Windows]", "red")
             filecontent.writelines(pocname+" success!!!"+"\n")
         elif vulnstr.find("LISTEN") != -1:
             cprint("Target exists" + pocname + "vulnerability..[Unknown OS]", "red")
             filecontent.writelines(pocname+" success!!!"+"\n")
         else:
             cprint("Target are not vulnerable to " + pocname, "green")
             cprint("\n")
...
|____/ \__|_|   \__,_|\__|___/    |____/ \___\__,_|_| |_|
                                        Code by Lucifer (Translated Version).
            ''', 'cyan')
        cprint("-------Detect struts2 vulnerability--------\nTarget url:"+self.url, "cyan")
        print("\n")
        filecontent.writelines("Detect struts2 vulnerability: "+self.url)
        filecontent.write("\n")
        try:
            ...
            cprint("Test struts2-005 timed out..", "cyan")
        ...
        try:
            ...
            cprint("Check struts2-008-1 timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Test struts2-008-2 timed out..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Test struts2-009 timed out..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Test struts2-013 timed out..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Test struts2-016 timed out..", "cyan")
            print("Timeout reason: ", e)

        try:
            req = requests.get(self.url+'/?redirect:https://www.google.com/%23', timeout=TMOUT, verify=False)
            if req.status_code == 302:
                cprint("The target has struts2-017 vulnerability.. (only provides detection)", "red")
                filecontent.writelines("struts2-017 success!!!\n")
            else:
                cprint("Struts2-017 vulnerability does not exist in the target..", "green")
        except Exception as e:
            cprint("Test struts2-017 timed out..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Check struts2-019 timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Check struts2-devmode timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Test struts2-032 timed out..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Test struts2-033 timed out..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Test struts2-037 timed out..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Test struts2-045 timed out..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            try:
                if r"1522756" in req.headers['testvuln']:
                    cprint("Struts2-045-2 vulnerability exists in the target..", "red")
                    filecontent.writelines("struts2-045-2 success!!!\n")
            except:
                pass
        except Exception as e:
            cprint("Test struts2-045-2 timed out..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Test struts2-046 timed out..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Test struts2-048 timed out..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            if req1.status_code == 200 and req2.status_code == 404:
                cprint("The target has struts2-020 vulnerabilities.. (only provides detection)", "red")
                filecontent.writelines("struts2-020 success!!!\n")
            else:
                cprint("Struts2-020 vulnerability does not exist in the target..", "green")
        except Exception as e:
            cprint("Test struts2-020 timed out..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            if req.status_code == 500 and r"java.security.Provider$Service" in req.text:
                cprint("The target has struts2-052 vulnerability.. (refer to the struts2_rest_xstream module in metasploit)", "red")
                filecontent.writelines("struts2-052 success!!!\n")
            else:
                cprint("Struts2-052 vulnerability does not exist in the target..", "green")
        except Exception as e:
            cprint("Test struts2-052 timed out..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            for param in params:
                ...
                tips = "Check struts2-053 post parameters: "+ param
                cprint(tips)
                self.check("struts2-053", req.text)
        except Exception as e:
            cprint("Check struts2-053 timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Test struts2-057-01 timed out..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Test struts2-057-2 timed out..", "cyan")
            print("Timeout reason: ", e)
...
|____/ \__|_|   \__,_|\__|___/    |____/ \___\__,_|_| |_|
                                        Code by Lucifer.
            ''','cyan')
        cprint("-------struts2 interactive shell--------\ntarget url:"+self.url, "cyan")
        prompt = "shell >>"
        ...
        if pocname == "struts2-053":
            param = input("Please specify Struts2-053 parameters: ")
            while True:
                print(prompt, end=' ')
                command = input()
                command = command.strip()
...
|____/ \__|_|   \__,_|\__|___/    |____/ \___\__,_|_| |_|
        ...
        '''
        cprint(figlet,'cyan')
        print("Usage: python struts-scan.py http://example.com/index.action - Detect")
        print("       python struts-scan.py -u http://example.com/index.action -i struts2-045 - Enter the specified vulnerability interactive shell")
        print("       python struts-scan.py -f url.txt - Batch testing")
